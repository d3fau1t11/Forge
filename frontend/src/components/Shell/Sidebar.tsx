    ...
    <aside className="w-64 border-r border-cyan-500/20 bg-obsidian-950/95 flex flex-col justify-between select-none z-20 backdrop-blur-xl relative">
        ...
        <nav className="p-3 space-y-4 overflow-y-auto max-h-[calc(100vh-230px)] font-mono relative z-10">
          ...
          <div>
            ...
            <button
              ...
              className={`w-full flex items-center space-x-2.5 px-3 py-2 rounded text-xs transition-all relative ${
          ...
          <div>
            ...
            <div className="space-y-1">
              <button
                ...
                className={`w-full flex items-center space-x-2.5 px-3 py-2 rounded text-xs transition-all ${
      ...
      <div className="p-3 border-t border-cyan-500/20 bg-obsidian-900/90 space-y-3 font-mono text-[11px] relative z-10">
        ...
        <button
          ...
          className={`w-full py-2.5 px-3 rounded font-display font-bold text-[11px] tracking-widest flex items-center justify-center space-x-2 transition-all duration-300 uppercase shadow-lg ${
            killSwitchActive
