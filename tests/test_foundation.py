...
class TestFoundation(unittest.TestCase):
    ...
    def test_live_provider_routing(self):
        ...
        self.assertIn(response.provider_name, ["groq", "cloudflare", "openrouter", "gemini", "nvidia", "agentrouter_claude_code", "agentrouter_codex", "rapidapi_gpt54_mini", "rapidapi_deepseek_v32", "rapidapi_gpt5_nano", "none"])
